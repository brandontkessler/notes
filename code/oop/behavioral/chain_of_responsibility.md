...
The oop version of if, elif, elif, else that allows users to rearrange
the order of conditionals at runtime.
...
![diagram](./../../../img/chainofResponsibilityClassDiagram.png)